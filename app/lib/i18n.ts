...
const englishUi: Record<string, string> = {
  ...
  '规则': 'Rules', '说明': 'Info', '历史记录': 'History', '返回': 'Back', '关闭': 'Close',
  '规则介绍': 'Rulebook', '查看完整网页版规则书': 'Open the official English PDF rulebook', '标准卡速查': 'Criteria Card Reference', '查看全部 48 张标准卡': 'Browse all 48 Criteria Cards',
  '查看本机保存的玩题记录': 'Puzzles saved on this device',
  '本机保存的每一道玩过的题目：默认题库、随机生成题与大师挑战。记录不会上传网络。': 'Every puzzle you have played on this device — challenge bank, random puzzles, and Turing Master challenges. Nothing is uploaded to the internet.',
  '暂无历史记录': 'No history yet', '开始玩题后，题目会自动记录在本机浏览器，并显示在这里。': 'Puzzles are recorded on this device automatically as you play them, and then appear here.',
  '该分类暂无记录': 'No puzzles in this category', '切换到其他分类，或先去玩一道这个难度的题目。': 'Switch to another category, or play a puzzle at this difficulty first.',
  '历史记录分类': 'History categories', '重新打开此题': 'Reopen This Puzzle', '玩过时间': 'Last played',
  '大师挑战': 'Turing Master', '默认题库': 'Challenge Bank', '随机生成题': 'Random Puzzle', '短代码': 'Short code',
  '已解开': 'Solved', '未解开': 'Unsolved', '正式挑战': 'Official Challenge', '练习挑战': 'Practice Challenge',
  '导出数据': 'Export Data', '导入数据': 'Import Data',
  '文件中没有可导入的历史记录。': 'No puzzle history was found in this file.',
  '导入失败，请选择本页面导出的 JSON 文件。': 'Import failed. Choose a JSON file exported from this page.',
  '大师挑战进行中，退出挑战后才能重新打开其他题目。': 'A Turing Master challenge is in progress. Leave the challenge to reopen another puzzle.',
